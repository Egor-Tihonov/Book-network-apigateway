...
func (c *userServiceClient) GetMySubscriptions(ctx context.Context, in *GetMySubscriptionsRequest, opts ...grpc.CallOption) (*GetMySybscriptionsResponse, error) {
	out := new(GetMySybscriptionsResponse)
...
func (UnimplementedUserServiceServer) GetMySubscriptions(context.Context, *GetMySubscriptionsRequest) (*GetMySybscriptionsResponse, error) {
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "pkg/user-service/pb/user.proto",
}
